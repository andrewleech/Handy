    ...
    pub fn new(app_handle: &AppHandle) -> Result<Self> {
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                files: vec![
                    ModelFile {
                        url: "https://huggingface.co/andrewleech/qwen3-asr-0.6b-int8-onnx/resolve/main/encoder.onnx".to_string(),
                        filename: "encoder.onnx".to_string(),
                        size_bytes: 758_407,
                        sha256: Some("d7e6a5896eb59d15f91eeecd92780d99af1a99cb6f73b2337aa5991cb0d9396d".to_string()),
                    },
                    ModelFile {
                        url: "https://huggingface.co/andrewleech/qwen3-asr-0.6b-int8-onnx/resolve/main/encoder.onnx.data".to_string(),
                        filename: "encoder.onnx.data".to_string(),
                        size_bytes: 577_189_920,
                        sha256: Some("91dc9c8f0f21e07da7fa4fcd691321a1f698b3dde2ab2ff6ac924d834eced200".to_string()),
                    },
                    ModelFile {
                        url: "https://huggingface.co/andrewleech/qwen3-asr-0.6b-int8-onnx/resolve/main/decoder_init.onnx".to_string(),
                        filename: "decoder_init.onnx".to_string(),
                        size_bytes: 2_054_417,
                        sha256: Some("dea3bfd7360422574d77d970f8785af713b7857dbf1d7f5f00695013822e5607".to_string()),
                    },
                    ModelFile {
                        url: "https://huggingface.co/andrewleech/qwen3-asr-0.6b-int8-onnx/resolve/main/decoder_init.onnx.data".to_string(),
                        filename: "decoder_init.onnx.data".to_string(),
                        size_bytes: 1_788_653_568,
                        sha256: Some("edffaa98c543b19dc397dae0b46cb26c88ee753e21e601704c225cd6a4bbdf62".to_string()),
                    },
                    ModelFile {
                        url: "https://huggingface.co/andrewleech/qwen3-asr-0.6b-int8-onnx/resolve/main/decoder_step.onnx".to_string(),
                        filename: "decoder_step.onnx".to_string(),
                        size_bytes: 2_080_405,
                        sha256: Some("bf314d4d4df0ba1da39e44b79e1e1375fcea3364da8cded99c4f6f3d51a8672e".to_string()),
                    },
                    ModelFile {
                        url: "https://huggingface.co/andrewleech/qwen3-asr-0.6b-int8-onnx/resolve/main/decoder_step.onnx.data".to_string(),
                        filename: "decoder_step.onnx.data".to_string(),
                        size_bytes: 1_788_653_568,
                        sha256: Some("edffaa98c543b19dc397dae0b46cb26c88ee753e21e601704c225cd6a4bbdf62".to_string()),
                    },
                    ModelFile {
                        url: "https://huggingface.co/andrewleech/qwen3-asr-0.6b-int8-onnx/resolve/main/embed_tokens.bin".to_string(),
                        filename: "embed_tokens.bin".to_string(),
                        size_bytes: 311_164_928,
                        sha256: Some("e80150119fa5f7e56e85aed64c3a02d5c78eb7a37cfdcb973d0987316f15bee2".to_string()),
                    },
                    ModelFile {
                        url: "https://huggingface.co/andrewleech/qwen3-asr-0.6b-int8-onnx/resolve/main/tokenizer.json".to_string(),
                        filename: "tokenizer.json".to_string(),
                        size_bytes: 11_429_377,
                        sha256: Some("bd2a97b55c8f7f9c328c73ee9b9178771037e9f566dfca8e238a063d41cbac92".to_string()),
                    },
                    ModelFile {
                        url: "https://huggingface.co/andrewleech/qwen3-asr-0.6b-int8-onnx/resolve/main/config.json".to_string(),
                        filename: "config.json".to_string(),
                        size_bytes: 1_224,
                        sha256: Some("4e51533c42ee0d48722102bd306053362845035c97bd36b6b732685934d9160f".to_string()),
                    },
                ],
            },
        );
